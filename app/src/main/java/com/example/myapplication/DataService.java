...
import static com.example.myapplication.Feed.FeedType.AD_FEED;
import static com.example.myapplication.Feed.FeedType.PHOTO_FEED;
...
public class DataService {
  ...
  private Feed generateFeed(int i) {
    Feed feed = new Feed();
    feed.id = i;
    feed.type = ((i == 5 || i == 10) ? AD_FEED : (i % 3 == 0 ? Feed.FeedType.NEWS_FEED : PHOTO_FEED));
